...
namespace AwesomeToon {
    ...
    public class AwesomeToonHelper : MonoBehaviour {
        ...
        // NOTE: If your game loads lights dynamically, this should be called to initialize new lights
        ...
        private LightSet CalcLight(LightSet lightSet) {
        ...
        private float TestInView(Vector3 dir, float dist) {
        ...
        private float CalcAttenuation(float dist) {
